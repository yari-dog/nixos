  ...
  services.udev.packages = [
    (pkgs.writeTextFile {
      ...
      text = ''
        ...
        # ASUS Ryujin III 360
        SUBSYSTEMS=="usb", ATTRS{idVendor}=="0b05", ATTRS{idProduct}=="1aa2", TAG+="uaccess"

        # ASUS Ryujin III EVA
        SUBSYSTEMS=="usb", ATTRS{idVendor}=="0b05", ATTRS{idProduct}=="1ade", TAG+="uaccess"

        # ASUS Ryujin III Extreme
        SUBSYSTEMS=="usb", ATTRS{idVendor}=="0b05", ATTRS{idProduct}=="1bcb", TAG+="uaccess"

        # ASUS Ryujin III White
        SUBSYSTEMS=="usb", ATTRS{idVendor}=="0b05", ATTRS{idProduct}=="1ada", TAG+="uaccess"
        ...
        SUBSYSTEMS=="usb", ATTRS{idVendor}=="0c70", ATTRS{idProduct}=="f00a", TAG+="uaccess"
        ...
        # Lian Li Uni AL V2
        SUBSYSTEMS=="usb", ATTRS{idVendor}=="0cf2", ATTRS{idProduct}=="a104", TAG+="uaccess"

        # Lian Li Uni SL
        SUBSYSTEMS=="usb", ATTRS{idVendor}=="0cf2", ATTRS{idProduct}=="7750", TAG+="uaccess"

        # Lian Li Uni SL
        SUBSYSTEMS=="usb", ATTRS{idVendor}=="0cf2", ATTRS{idProduct}=="a100", TAG+="uaccess"

        # Lian Li Uni SL V2
        SUBSYSTEMS=="usb", ATTRS{idVendor}=="0cf2", ATTRS{idProduct}=="a103", TAG+="uaccess"

        # Lian Li Uni SL V2
        SUBSYSTEMS=="usb", ATTRS{idVendor}=="0cf2", ATTRS{idProduct}=="a105", TAG+="uaccess"

        # Lian Li Uni SL-Infinity
        SUBSYSTEMS=="usb", ATTRS{idVendor}=="0cf2", ATTRS{idProduct}=="a102", TAG+="uaccess"
        ...
        # NZXT 2023 RGB Controller
        SUBSYSTEMS=="usb", ATTRS{idVendor}=="1e71", ATTRS{idProduct}=="2021", TAG+="uaccess"

        # NZXT Control Hub
        SUBSYSTEMS=="usb", ATTRS{idVendor}=="1e71", ATTRS{idProduct}=="2022", TAG+="uaccess"
        ...
        SUBSYSTEMS=="usb", ATTRS{idVendor}=="1e71", ATTRS{idProduct}=="3014", TAG+="uaccess"
